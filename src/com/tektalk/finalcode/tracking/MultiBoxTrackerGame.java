...
package com.tektalk.finalcode.tracking;
...
import com.tektalk.finalcode.DetectorActivity;
...
import com.tektalk.finalcode.Classifier.Recognition;
...
public class MultiBoxTrackerGame {
  ...
  public MultiBoxTrackerGame(final Context context) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      final String labelString =
          !TextUtils.isEmpty(recognition.title)
              ? String.format("", recognition.title, recognition.detectionConfidence)
              : String.format("", recognition.detectionConfidence);
  ...
  public synchronized void onFrame(
    ...
    if (objectTracker == null && !initialized) {
      ...
      if (objectTracker == null) {
        final Toast myToast = Toast.makeText(context, "TEKTALK GAME", Toast.LENGTH_LONG);
        myToast.show();
  ...
  private void processResults(
    ...
    if (objectTracker == null) {
      ...
      for (final Pair<Float, Recognition> potential : rectsToTrack) {
        ...
        //trackedRecognition.title = GameActivity.getNamestringsss();
  ...
  public List<Pair<Float, RectF>> getScreenRects() {
    return screenRects;
  }
